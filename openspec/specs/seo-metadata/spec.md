...
### Requirement: Site analytics

The site SHALL load Vercel Analytics from the root layout on all pages. Google Analytics MUST NOT be included.

#### Scenario: Analytics on quote page

- **WHEN** a user loads `/get-a-quote`
- **THEN** Vercel Analytics is active and no Google Analytics scripts are present
