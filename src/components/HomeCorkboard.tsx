  ...
  return [
    {
      ...
      color: W.peach,
      title: "WEB DEV",
      body: "WordPress, Shopify, custom builds — sites that don't break.",
      tag: "SERVICE",
    },
    {
      id: 2,
      ...
      color: W.lilac,
      title: "BRAND",
      body: "Identity refreshes that don't bore.",
      tag: "SERVICE",
    },
    {
      id: 7,
    ...
    },
    {
      ...
      color: W.green,
      title: "MARKETING",
      body: "Plain-English SEO. Email people read.",
      tag: "SERVICE",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      color: W.pink,
      title: '"GAME-CHANGER."',
      body: "— La Planchette, Windsor\nfully booked most weekends.",
      tag: "QUOTE",
    },
    {
      id: 6,
      ...
      color: W.blue,
      title: "WHO'S IT FOR?",
      body: "Cafés, indie founders, pet shops, anyone with a small business and a big idea.",
      tag: "NOTE",
    },
    {
      id: 8,
      ...
      textColor: "#fff",
      title: "GET IN TOUCH →",
      body: "hello@therenthen.co.uk",
      tag: "CTA",
    },
  ];
}

export default function HomeCorkboard() {
